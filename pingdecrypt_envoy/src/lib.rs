...
impl Context for DecryptRoot {}

impl RootContext for DecryptRoot {
...
pub fn _start() {
    ...
    proxy_wasm::set_http_context(|context_id, _| -> Box<dyn HttpContext> {
        Box::new(Decrypt { context_id })
    });
}

impl Context for Decrypt {
    fn on_http_call_response(&mut self, _: u32, _: usize, _body_size: usize, _: usize) {
        self.resume_http_request();
    }
}

impl HttpContext for Decrypt {
